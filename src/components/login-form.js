...
class LoginForm extends Component{
    ...
    render(){
        return(        
            <Container fluid className={"contact-s2 align-items-center p-0 py-5 d-flex "+this.props.classExt}>
                <Row className="mx-auto text-start w-100 pt-5">
                    <Col xs={11} md={5} lg={4} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 border border-white p-4 rounded bg-form shadow text-white fw-bold"
                            autoComplete="off"
                            method="POST">
                            ...
                            <Form.Group controlId="formLogin">
                                <Form.Label>Login</Form.Label>
                                 <Form.Control type="text" 
                                    ...
                                    className="rounded-pill border-secondary text-dark"
                                    maxLength="50"
                                    name="userName"
